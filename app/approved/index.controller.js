(function () {
    ...
    angular
        .module('app')
        .controller('Approved.IndexController', Controller);
    ...
    function Controller($window, UserService, FlashService,$mdDialog, $scope) {
      ...
      vm.user2 = null;
      vm.org = { first: 0,sort:"dt",stats : "Approved",retur : "No",deliv : "No",pos: $scope.vmain.user.pos,dept: $scope.vmain.user.dept};
       initController();
